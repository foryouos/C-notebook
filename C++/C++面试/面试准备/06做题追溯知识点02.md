...
>![网络层次](https://img-blog.csdnimg.cn/2020111209084487.png)
>
...
>
> 给定一个单链表的头结点`pHead`该头节点是有值的，比如在下图，它的val是1)，长度为n，反转该链表后，返回`新链表`的表头。
> 数据范围： 0≤10000≤*n*≤1000
> 要求：空间复杂度 *O*(1) ，时间复杂度 O*(*n*) 。

## 正解迭代

![反转链表迭代法](https://mmbiz.qpic.cn/mmbiz_jpg/ORog4TEnkbucZCeIYhyYp7UQbMMwAwkjibLZ869v7TuiaZHUBH5K84TWnEyO5xBRuuJrtQbUeiaM4lQbTxmibHwEQw/640?wx_fmt=jpeg "反转链表迭代法")
